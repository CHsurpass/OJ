...
import top.qoj.dao.judge.JudgeCaseEntityService;
import top.qoj.dao.judge.JudgeEntityService;
import top.qoj.dao.problem.ProblemEntityService;
import top.qoj.dao.user.UserAcproblemEntityService;
import top.qoj.exception.AccessException;
import top.qoj.judge.remote.RemoteJudgeDispatcher;
import top.qoj.judge.self.JudgeDispatcher;
...
import top.qoj.validator.JudgeValidator;
    ...
    public SubmissionInfoVO getSubmission(Long submitId) throws StatusNotFoundException, StatusAccessDeniedException {
        ...
        if (judge.getCid() != 0) {
            ...
            if (!isRoot && contest.getIsGroup() && judge.getCode() != null) {
                try {
                    accessValidator.validateAccess(QOJAccessEnum.HIDE_NON_CONTEST_SUBMISSION_CODE);
