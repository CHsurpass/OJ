...
import top.qoj.pojo.bo.HydroConfigYamlBO;
...
public class ImportHydroProblemManager {
    ...
    public void importHydroProblem(MultipartFile file) throws StatusSystemErrorException, StatusFailException {
        ...
        for (File dir : files) {
            if (dir.isDirectory()) {
                ...
                ProblemDTO problemDto = buildProblemDto(userRolesVo.getUsername(), rootDirPath, languageMap, languageList);
    ...
    private ProblemDTO buildProblemDto(String author,
        ...
        parseProblemYaml(problemYaml, dto, problem);
