...
import top.qoj.exception.ProblemIDRepeatException;
import top.qoj.mapper.ProblemMapper;
import top.qoj.pojo.bo.Pair_;
...
import top.qoj.pojo.entity.problem.*;
...
public class ProblemEntityServiceImpl extends ServiceImpl<ProblemMapper, Problem> implements ProblemEntityService {
    ...
    public boolean adminUpdateProblem(ProblemDTO problemDto) {
        ...
        if (problemUpdateResult && checkProblemCase && deleteLanguagesFromProblemResult
                && addLanguagesToProblemResult && deleteTemplate && saveOrUpdateCodeTemplate) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean adminAddProblem(ProblemDTO problemDto) {
        ...
        if (addCasesToProblemResult && addLangToProblemResult && addProblemCodeTemplate) {
            return true;
        } else {
            return false;
        }
